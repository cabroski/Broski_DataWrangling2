...
collar_files <- length(collar_files)
results <- data.frame(filename = vector(mode = "character", length = collar_files),
                       max_lat = vector(mode = "numeric", length = collar_files),
                       min_lat = vector(mode = "numeric", length = collar_files))
for (i in 1:collar_files) {
  filename <- collar_files[i]
  data <- read.csv(paste0("../data_raw/individual_collar_data/", filename))
